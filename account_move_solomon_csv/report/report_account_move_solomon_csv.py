        ...
        for record in records:
            ...
            for line in record.line_ids:
                ...
                vals = {
                    ...
                    # FIXME: Should we add a new field to keep English name?
                    labels[2]: line.account_id.name,
                    labels[3]: project_line.account_id.name or "",
                    labels[4]: project_line.account_id.code or "",
                    labels[5]: sub_line.account_id.name or "",
                    ...
                    labels[17]: tax_inclusive,
                    labels[18]: tax.solomon_tax_category or "",
                    labels[19]: tax.solomon_tax_id or "",
                }
